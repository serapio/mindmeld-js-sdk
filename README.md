...
```html
<script type="text/javascript" src="https://developer.expectlabs.com/public/sdks/mindmeld-2.5.0.js"></script>
```

* Un-minified: [mindmeld-2.5.0.js][versionedSDKDownloadLink]
* Minified: [mindmeld-2.5.0.min.js][versionedMinifiedSDKDownloadLink]
* Both + Hello World + Documentation: [mindmeld-js-sdk-2.5.0.zip][versionedSDKZIPDownloadLink]
...
[versionedSDKDownloadLink]:https://developer.expectlabs.com/public/sdks/mindmeld-2.5.0.js
[versionedMinifiedSDKDownloadLink]:https://developer.expectlabs.com/public/sdks/mindmeld-2.5.0.min.js
[versionedSDKZIPDownloadLink]:https://developer.expectlabs.com/public/sdks/mindmeld-js-sdk-2.5.0.zip
